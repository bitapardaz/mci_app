    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(blank=True, to='mtn_rbt.MTN_Album', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='MTN_Category',
            fields=[
                ...
                ('photo', models.ImageField(null=True, upload_to=b'', blank=True)),
                ('confirmed', models.BooleanField(default=False)),
                ('parent', models.ForeignKey(blank=True, to='mtn_rbt.MTN_Category', null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date_published', models.DateTimeField(auto_now=True)),
                ('album', models.ForeignKey(to='mtn_rbt.MTN_Album')),
                ('category', models.ForeignKey(to='mtn_rbt.MTN_Category')),
            ],
        ),
        migrations.CreateModel(
            name='MTN_MainAdvert',
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, to='mtn_rbt.MTN_Category', null=True),
        ),
        migrations.AddField(
            model_name='mtn_album',
            name='category',
            field=models.ForeignKey(to='mtn_rbt.MTN_Category'),
        ),
        migrations.AddField(
            model_name='mtn_album',
            name='producer',
